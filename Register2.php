...
<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" style="border:1px solid #ccc">
  <div class="container">
    <h1>Client Information</h1>
    <p>Please fill in this form to finalize your account.</p>
    <hr>
 
 <!--if we can show company here-->
 
    <label for="firstname"><b>First Name:</b></label> 
    <br>
   <input type="text" placeholder="Enter First Name" value="<?=$firstName?>" name="fname" required>
   <br>

   <label for="lastname"><b>Last Name:</b></label> 
    <br>
   <input type="text" placeholder="Enter Last Name" value="<?=$lastName?>" name="lname" required>
   <br>

   <label for="phone"><b>Phone Number:</b></label> 
    <br>
   <input id="phone"  type="text" value="<?=$phone?>" name="phone" value="(___)-___-____"  pattern="[0-9]{3}[0-9]{3}[0-9]{4}$" />
   <br>
    
    <label for="remail"><b>Email:</b></label> 
    <br>
   <input type="text" placeholder="Enter Email" value="<?=$email?>" name="email" required>
   <br>
    ...
    <br>
    <input type="password" placeholder="Repeat Password" name="pwordrepeat" required>
    <br>
    ...
    <div class="clearfix">
		<button type="submit" name="signup" value="signup" class="signupbtn"> <a ref="Profile.html">Finish</a></button>
